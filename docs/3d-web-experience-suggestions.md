...
- **Idea**: Convertir los personajes principales en modelos GLB/GLTF optimizados (baja poligonización <100k, texturas WebP integradas) y usar `useAnimations` para darles un estado _idle_ (respirando) cuando están quietos, o una animación de saludo cuando entran en escena.
