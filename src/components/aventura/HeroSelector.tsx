  ...
  return (
    <div className="bg-sky-blue relative flex min-h-screen w-full flex-col px-4 py-8 sm:px-6 overflow-hidden">
      ...
      <header className="relative z-10 text-center pt-4">
        <div className="pixel-text bg-night text-golden-coin mx-auto inline-flex items-center gap-2 rounded-md px-4 py-2 text-[10px] tracking-widest uppercase border-2 border-night shadow-[3px_3px_0_#000]">
          <Gamepad2 className="h-4 w-4" /> Selección de Skin
        </div>
        <h2 className="font-display text-white mt-4 text-4xl sm:text-5xl drop-shadow-[4px_4px_0_#4E342E] uppercase tracking-wide">
          Elegí a tu héroe
        </h2>
      </header>
      ...
      <div className="relative z-10 mt-6 flex flex-1 items-center justify-center max-w-4xl mx-auto w-full">
        ...
        <button
          onClick={prev}
          aria-label="Anterior"
          className="bg-white text-night border-4 border-night rounded-xl p-3 sm:p-4 shadow-[4px_4px_0_#000] hover:bg-gray-100 active:translate-y-1 active:shadow-[0px_0px_0_#000] transition-all z-20"
        >
        ...
        <div className="mx-2 sm:mx-6 max-w-sm flex-1 relative perspective-1000">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={`flex flex-col items-center gap-4 p-6 sm:p-8 rounded-3xl border-4 border-night shadow-[8px_8px_0_#000] ${hero.color}`}
            >
              ...
              <div className="text-center w-full">
                <h3 className="font-display text-white text-3xl sm:text-4xl tracking-wide uppercase drop-shadow-[2px_2px_0_#000]">
                  {hero.name}
                </h3>
      ...
      <div className="relative z-10 mt-8 mb-6 flex justify-center w-full max-w-sm mx-auto">
        <button
          ...
          className="bg-grass-green text-white border-4 border-night w-full rounded-2xl px-6 py-4 font-display uppercase tracking-widest text-xl sm:text-2xl shadow-[4px_8px_0_#000] hover:translate-y-1 hover:shadow-[4px_4px_0_#000] active:translate-y-2 active:shadow-none transition-all flex items-center justify-center gap-3"
        >
          🎮 ¡ELEGIR A {hero.name}!
        </button>
      </div>
