...
function Loader() {
  ...
  return (
    <Html center className="font-display text-white text-xl drop-shadow-[2px_2px_0_var(--color-night)]">
      {progress.toFixed(0)}%
    </Html>
  )
}
...
export function World3D() {
  return (
    <div className="absolute inset-0 z-0 bg-sky-blue overflow-hidden pointer-events-none">
      <Canvas
