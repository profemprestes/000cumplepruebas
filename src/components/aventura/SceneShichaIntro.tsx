      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-end gap-6 pb-8">
        <div className="flex items-end gap-2 sm:gap-4">
          <motion.img
            ...
            className="animate-float h-40 w-40 object-contain drop-shadow-[4px_4px_0_oklch(0.18_0.04_260/0.4)] sm:h-56 sm:w-56"
          />
          <motion.img
            src={SHICKA_IMG}
            alt="Shicka"
            ...
            className="animate-float h-44 w-44 object-contain drop-shadow-[4px_4px_0_oklch(0.18_0.04_260/0.4)] sm:h-60 sm:w-60"
          />
        </div>
